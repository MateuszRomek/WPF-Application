    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviePlatforms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MoviePlatforms_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MoviePlatforms_Platforms_PlatformId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoviePlatforms_MovieId",
                table: "MoviePlatforms",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_MoviePlatforms_PlatformId",
                table: "MoviePlatforms",
                column: "PlatformId");
